...
4. **编码**：根据[`Float24`](vscode-file://vscode-app/Applications/Visual Studio Code.app/Contents/Resources/app/out/vs/code/electron-sandbox/workbench/workbench.html)的格式，将规格化后的数编码为符号位、指数位和尾数位。
